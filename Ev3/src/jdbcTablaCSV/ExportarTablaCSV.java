...
public class ExportarTablaCSV extends JFrame {
	...
	public ExportarTablaCSV() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExportarTablaCSV.class.getResource("/jdbcTablaCSV/bien.png")));
		...
		panel.setBorder(new TitledBorder(null, "Conexión a MySQL",
		...
		label_3.setBounds(335, 64, 61, 55);
		panelExport.add(label_3);
		...
		tablas.setBounds(307, 55, 156, 25);
